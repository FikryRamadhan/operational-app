...
use App\MyClass\XLSXWriterBuffererWriter;
use ZipArchive;
...
class XLSXWriter
{
	...
	protected function writeCell(XLSXWriterBuffererWriter &$file, $row_number, $column_number, $value, $num_format_type, $cell_style_idx)
	{
