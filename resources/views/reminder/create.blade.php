			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" name="reminder_name" class="form-control" placeholder="Nama Reminder">
					...
					<div class="form-group">
						...
						<textarea name="notes" class="form-control" placeholder="Nama Reminder (Opsional)" rows="3"></textarea>
						<span class="invalid-feedback"></span>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" name="reminder_target" class="form-control" placeholder="Nomor Whatsapp Target Reminder">
						<span class="invalid-feedback"></span>
					</div>
...
<script>
	...
	$(function(){
		...
		const resetForm = () => {
			...
			$form.find(`#reminder-time-container`).empty()
