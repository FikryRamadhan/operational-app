	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				...
				<td align="right"> Rp. {{ number_format($transaction->nominal * -1) }} </td>
			</tr>
			@empty
			<tr>
			...
			@endforelse
			<tr>
				<td align="right" colspan="3"><b> Total Pengeluaran </b></td>
				<td align="right"><b> Rp {{ number_format($balance * -1) }} </b></td>
			</tr>
		</tbody>
	</table>
